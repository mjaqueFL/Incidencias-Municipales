...
//$route['menuanadirclase'] = 'ControladorDefuncionesBD/veranadir';
//$route['anadirclase'] = 'ControladorDefuncionesBD/add';
//$route['modificarclases/(:num)'] = 'ControladorDefuncionesBD/verclase/$1';
//$route['verclases'] = 'ControladorDefuncionesBD/verclases';
//$route['eliminarclases/(:num)'] = 'ControladorDefuncionesBD/eliminar/$1';
