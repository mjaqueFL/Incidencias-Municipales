...
<strong>Identidad:</strong> ProyectosAntonio<br>
<strong>Domicilio social:</strong> Calle Granada Nº40<br>
<strong class="ng-binding">DNI:</strong> 8026938V<br>
<strong>Teléfono:</strong>  616265089<br>
<strong>Correo Electrónico:</strong> abarrilhernandez.guadalupe@alumnado.fundacionloyola.net<br>
<strong>Contacto:</strong> Antonio Barril Hernandez<br>
<strong>Nombre del dominio:</strong> ProyectodeIncidencias<br>
  ...
  <p>En cumplimiento de lo dispuesto en el Reglamento Europeo 2016/679 General de Protección de Datos, te informamos de que trataremos los datos que nos facilitas para:</p>
    <ul>
      ...
      <li class="ng-binding">Remitir periódicamente comunicaciones sobre servicios, eventos y noticias relacionadas con las actividades desarrolladas por ProyectosAntonio, por cualquier medio (teléfono, correo postal o email), salvo que se indique lo contrario o el usuario se oponga o revoque su consentimiento.</li>
  ...
  <p class="ng-binding">Derivada de las finalidades antes mencionadas, en ProyectosAntonio  gestionamos las siguientes categorías de datos:</p>
  <ul>
    <li>Datos identificativos</li>
    <li>Metadatos de comunicaciones electrónicas</li>
    <li class="ng-binding">Datos de información comercial. En caso de que el usuario facilite datos de terceros, manifiesta contar con el consentimiento de estos y se compromete a trasladarle la información contenida en esta cláusula, eximiendo a ProyectosAntonio de cualquier responsabilidad en este sentido.</li>
    <li class="ng-binding">No obstante,  ProyectosAntonio  podrá llevar a cabo las verificaciones para constatar este hecho, adoptando las medidas de diligencia debida que correspondan, conforme a la normativa de protección de datos.</li>
  </ul>
...
Por último, los datos se podrán utilizar para dar cumplimiento a las obligaciones legales aplicables a ProyectosAntonio
</p>
...
<p class="ng-binding">ProyectosAntonio  conservará los datos personales de los usuarios únicamente durante el tiempo necesario para la realización de las finalidades para las que fueron recogidos, mientras no revoque los consentimientos otorgados. Posteriormente, en caso de ser necesario, mantendrá la información bloqueada durante los plazos legalmente establecidos.</p>

  <h3>Destinatarios ¿A qué destinatarios se comunicarán tus datos?</h3>

<p class="ng-binding">Tus datos podrán ser accedidos por aquellos proveedores que prestan servicios a ProyectosAntonio, tales como servicios de alojamiento, herramientas de marketing  y  sistemas  de contenido u otros profesionales, cuando dicha comunicación sea necesaria normativamente, o para la ejecución de los servicios contratados.<br><br>
ProyectosAntonio, ha suscrito los correspondientes contratos de encargo de tratamiento con cada uno de los proveedores que prestan servicios a ProyectosAntonio, con el objetivo de garantizar que dichos proveedores tratarán tus datos de conformidad con lo establecido en la legislación vigente.<br><br>
...
<ul>
  <li class="ng-binding">Encriptación de las comunicaciones entre el dispositivo del usuario y los servidores de ProyectosAntonio </li>
  <li class="ng-binding">Encriptación de la información en los propios servidores de ProyectosAntonio</li>
  <li>Otras medidas que eviten el acceso a los datos del usuario por parte de terceros.</li>
  <li class="ng-binding">En aquellos casos en los que ProyectosAntonio  cuente con prestadores de servicio para el mantenimiento de la plataforma que se encuentren fuera de la Unión Europea, estas trasferencias internacionales se hayan regularizadas atendiendo al compromiso de ProyectosAntonio  con la protección, integridad y seguridad de los datos personales de los usuarios.</li>
</ul>            

<h3>Derechos – ¿Cuáles son tus derechos cuando nos facilitas tus datos y cómo puedes ejercerlos?</h3>
<p class="ng-binding">
 Tienes derecho a obtener confirmación sobre si en ProyectosAntonio estamos tratando datos personales que te conciernan, o no.<br>
...
En determinadas circunstancias y por motivos relacionados con tu situación particular, podrás oponerte al tratamiento de tus datos. ProyectosAntonio  dejará de tratar los datos, salvo por motivos legítimos imperiosos, o el ejercicio o la defensa de posibles reclamaciones.<br><br>
...
Si deseas hacer uso de cualquiera de tus derechos puede dirigirse a <a href="mailto:abarrilhernandez.guadalupe@alumnado.fundacionloyola.net" class="ng-binding">abarrilhernandez.guadalupe@alumnado.fundacionloyola.net</a>. <br><br>
...
<p class="ng-binding">
   ProyectosAntonio podrá modificar la presente Política de Privacidad en cualquier momento, siendo publicadas las sucesivas versiones en el Sitio Web. En cualquier caso, ProyectosAntonio comunicará con previo aviso las modificaciones de la presente política que afecten a los usuarios a fin de que puedan aceptar las mismas. <br><br>
