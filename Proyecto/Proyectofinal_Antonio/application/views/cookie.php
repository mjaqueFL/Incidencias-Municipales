...
<p class="ng-binding">La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página ProyectodeIncidencias, propiedad de Antonio Barril Hernandez – Calle Granada Nº40.</p>
            ...
            <p>Las cookies utilizadas en nuestro sitio web, son de sesión y de terceros, y nos permiten almacenar y acceder a información relativa al idioma, el tipo de navegador utilizado, y otras características generales predefinidas por el usuario, así como, seguir y analizar la actividad que lleva a cabo, con el objeto de introducir mejoras y prestar nuestros servicios de una manera más eficiente y personalizada. <br><br>
              ...
              Antonio Barril Hernandez) o bien cuando se borran manualmente. </p>  
<p></p>
...
<tbody>
                        ...
                        <tr>
                            <td>cookies_aceptada</td>
                            <td>Local</td>
                            <td>3 meses</td>
                            <td>Se usa para saber si ha acceptado las cookies</td>
                            <td>Antonio Barril Hernandez</td>
                        </tr>
                        </tbody>
</table>
            ...
            <p class="ng-binding">Importante: Salvo que el usuario decida registrarse en un servicio de
              Antonio Barril Hernandez, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.</p>
